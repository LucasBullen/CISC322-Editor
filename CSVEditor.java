// $Id: CSVEditor.java,v 1.2 2012/12/14 20:23:49 dalamb Exp dalamb $
...
public class CSVEditor extends Application {
    ...
    private static String copyright = "2016 Group 1";
	...
	// Localizers.Menu.getLocalizer().addBaseName(packageName+".CSV");
	// Localizers.Message.getLocalizer().addBaseName(packageName+".CSV");
	addLocalizerBaseName(packageName+".CSV");
	...
	finishSetup();
	//System.err.println("Got to end of CSV Editor constructor");
